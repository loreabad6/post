...
To facilitate `post_*` object creation the family of functions [`summarise_geometry_*()`](`?summarise_geometry`) is provided.
...
## Custom summary geometry funcions
...
#| fig-cap: 
#|   - "Original sf object"
#|   - "Point on surface of changing geometries"
par(mar = c(0,0,0,0))
plot(polygons["gid"], key.pos = NULL, main = NULL, reset = FALSE)
plot(
  summarise_geometry_custom(
    polygons, group_id = "gid", sf_column_name = "geometry"
  ), col = pal, pch = 19, cex = 3
)
```
