...
![Changing geometries](figs/geoms-complete-post.png){#fig-geoms}

![`post_array` class](figs/post_array-vdc.png){#fig-array}

![`post_table` class](figs/post_table-vdc.png){#fig-table}
:::
